...
export const Academics: React.FC<AcademicsProps> = ({ content, onNavigate, currentPage }) => {
  ...
  // Course descriptions mapping (1 unit = 45 hours)
  const courseDescriptions: Record<string, string> = {
    ...
    "Contracts I": "This course examines the law governing private agreements, including the enforcement of promises, precontractual liability, and statutory requirements such as the statute of frauds. It covers the analysis of legal enforceability of agreements, breach of contract, and available remedies. Key issues include contract formation, the rights of parties under contracts, and performance conditions. Emphasis will be placed on contract interpretation and the interrelationship with other areas of law such as torts, property, and restitution. (3 Units - 135 hours)",
    "Contracts II": "This course examines the law governing private agreements, including the enforcement of promises, precontractual liability, and statutory requirements such as the statute of frauds. It covers the analysis of legal enforceability of agreements, breach of contract, and available remedies. Key issues include contract formation, the rights of parties under contracts, and performance conditions. Emphasis will be placed on contract interpretation and the interrelationship with other areas of law such as torts, property, and restitution. (3 Units - 135 hours)",
    "Torts I": "Focusing on personal injury law, this course examines negligence and the evolving nature of negligence law. It also covers intentional torts, contemporary rules, and strict liability. The course explores alternative compensation systems such as no-fault insurance, addressing societal needs for victim compensation. (3 Units - 135 hours)",
    "Torts II": "Focusing on personal injury law, this course examines negligence and the evolving nature of negligence law. It also covers intentional torts, contemporary rules, and strict liability. (3 Units - 135 hours)",
    ...
    "FYLSX Review": "This course prepares first-year law students for the California First-Year Law Students' Examination (FYLSE) through focused review of Contracts, Criminal Law, and Torts. Students develop doctrinal mastery, issue-spotting skills, and effective test-taking strategies through lectures, weekly practice quizzes, and timed simulated examinations. The course emphasizes accurate rule application, analytical precision, and performance under exam conditions, culminating in a final review and strategy session to support readiness for the FYLSE. (3 Units - 135 hours)",
    "Civil Procedure": "This course explores civil litigation procedures, including the commencement of suits, pleadings, discovery, and trial processes. Topics covered include court jurisdiction, class actions, summary judgment, and the appeal process. (6 Units - 270 hours)",
    "Property": "This course examines property law, focusing on various property interests, landlord-tenant relationships, land use, and the sale and financing of real estate. (6 Units - 270 hours)",
    ...
    "Uniform Commercial Code": "This course provides a comprehensive study of the Uniform Commercial Code (UCC), the foundational body of law governing commercial transactions in the United States. Students will explore the structure, purpose, and application of the UCC across its major Articles, including sales of goods, negotiable instruments, secured transactions, and commercial paper. Emphasis will be placed on statutory interpretation, case law analysis, and problem-solving in practical contexts. The course will also highlight the UCC's role in promoting uniformity in commercial law, its interaction with common law principles, and its adaptation to modern business practices. By the end of the course, students will be equipped to apply UCC provisions to real-world commercial disputes and transactions. (3 Units - 135 hours)",
    "Law & Motion": "This class is designed to introduce students to the skills necessary to write both procedural and substantive motions. Since this course was chosen specifically to continue to develop and strengthen the writing skills necessary to perform successfully on the California Bar, the instruction will be presented as an intensive writing class. (1 Unit - 45 hours)",
    "Evidence": "This course delves into the principles and application of evidence law, focusing on the Federal Rules of Evidence. Topics include relevance, credibility, hearsay, impeachment, and the presentation of evidence in court. (6 Units - 270 hours)",
    "Constitutional Law": "This course explores the U.S. Constitution, including the distribution of governmental powers, judicial review, and individual rights. A primary focus will be on the First Amendment and its guarantees of free speech, press, assembly, and religious freedom. (6 Units - 270 hours)",
    "Business Associations": "This course provides a comprehensive study of the legal principles governing business entities and agency relationships. Students will explore the formation, rights, duties, and liabilities of agents, principals, and various business structures including general partnerships, limited partnerships, limited liability partnerships, corporations, limited liability companies, joint ventures, and sole proprietorships. Emphasis is placed on understanding fiduciary obligations, authority, liability in contract and tort, and the mechanisms of dissociation, dissolution, and corporate governance. The course also examines securities regulation, mergers and acquisitions, and the unique rules applicable to closely-held and non-profit corporations. By integrating theory with practical applications, students will gain the analytical skills necessary to navigate complex organizational and agency issues in both litigation and transactional contexts. (4 Units - 180 hours)",
    "Community Property": "A detailed examination of California's community property system, this course covers property relations between spouses and domestic partners, and the implications of divorce or death. The course prepares students for issues on the California State Bar Examination and encourages active participation through the \"assigned expert\" system. (4 Units - 180 hours)",
    "Alternative Dispute Resolution": "This course introduces students to the theory and practice of Alternative Dispute Resolution (ADR), focusing on negotiation, mediation, arbitration, and hybrid processes. Students will examine the strengths and limitations of ADR compared to litigation, explore ethical and policy considerations, and develop practical skills in managing disputes. The course emphasizes statutory frameworks, case law, and real-world applications, preparing students to analyze, design, and participate effectively in dispute resolution processes. By engaging with both doctrinal materials and experiential exercises, students will gain a comprehensive understanding of ADR's role in the modern legal system. (3 Units - 135 hours)",
    "Judicial Decision Making": "Judicial Decision Making takes a comprehensive look at how judges make decisions in common law systems. The course aims to equip students with a deeper understanding of the legal system and the role of attorneys and judges in shaping it. Students will examine the various factors that influence judicial decision making. Students will also explore the role of constitutional interpretation, statutory interpretation, precedent, and policy and tradition in shaping judicial decisions. Students will also examine the five types of legal arguments and critically evaluate the strengths and weaknesses of these approaches and how they impact the development of the law. (3 Units - 135 hours)",
    ...
    "Wills & Succession": "This course provides a comprehensive study of succession law, focusing on the rules governing the transfer of property upon death. Students will explore the general provisions affecting married persons, contractual arrangements, and simultaneous death scenarios. The course examines intestate succession, the validity and execution of wills, and the doctrines surrounding revocation, revival, and omitted heirs. Special attention is given to the interpretation of testamentary instruments, the role of witnesses, and the choice of law in cross-jurisdictional contexts. By analyzing statutory frameworks and case law, students will gain a deep understanding of how property rights, family relationships, and legal formalities intersect in estate planning and inheritance disputes. (4 Units - 180 hours)",
    "California Civil Procedure": "This course focuses on California's civil procedural rules, including the rules governing civil proceedings and the jury trial system. (2 Units - 90 hours)",
    "Advanced Legal Research & Writing": "This course is designed to refine students' legal research and writing skills for professional practice. Building on foundational competencies, students will learn advanced techniques for locating, analyzing, and applying legal authority across jurisdictions. The writing component emphasizes clarity, precision, and persuasive strategy in drafting legal memoranda, motions, briefs, and client communications. Students will engage in simulated law practice settings, receive individualized feedback, and develop the ability to produce high-quality legal documents under time constraints. The course prepares students for real-world legal work, bar exam performance, and law review-level writing. (3 Units - 135 hours)",
    "California Evidence": "This course focuses on California's Evidence Code, comparing it to the Federal Rules of Evidence, with particular attention to areas where the California rules differ. (2 Units - 90 hours)",
    "Practical Competency Training": "This course offers practical training in legal practice, emphasizing the essential skills for ethical and competent lawyering. There are two available tracks: the first track (Track 1) is a legal internship/Externship in a law practice environment focused on learning hands-on law practice skills and the second track (Track 2) is focused on an in-class academic study of advanced law practice skills. 4L students in Track 1 will participate in an internship outside the classroom, earning up to six units. These internships must receive approval from the law school and are closely monitored by PAUSL faculty to ensure the work is relevant and meaningful to law practice. The legal internship will be supervised and evaluated by a faculty member and will be assessed weekly via the student's internship journal and a rubric covering the same learning outcomes of the Practical Competency Training Course's Track 2. Track 2 is an academic study of the practical skills required for establishing and maintaining a law practice. This second track includes lawyering skills such as client intake, discovery, case management, calendaring, file security, and providing effective legal counsel. Additionally, students will examine law practice from the perspective of business management and AI. (6 Units - 270 hours)",
    "Bar Review": "The California State Bar Examination review course includes comprehensive coverage of all subjects tested on the California State Bar Examination. These subjects encompass Business Associations, Contracts, Criminal Law and Procedure, Remedies, Civil Procedure, Evidence, Torts, Community Property, Professional Responsibility, Trusts, Constitutional Law, Real Property, and Wills and Succession. The course also delves into essay writing techniques, performance test strategies, and multiple-choice questions consistent with those found on the Multistate Bar Exam (MBE) which makes up a portion of the California State Bar Examination. Students engage in timed writing assignments, performance tests, and mock MBE exams to hone their skills. Note: Separate from the Bar Review course, 4L students will be able to register for commercial Bar Prep with a $200 setup fee (any additional costs will be covered by the school), and continue to receive support from the school even after graduating. (4 Units - 180 hours)"
  };
                  ...
                  {[
                    ...
                    { 
                      ...
                      courses: [
                        ...
                        "Remedies", 
                        "Criminal Procedure",
                        "Uniform Commercial Code (Elective)",
                        "Law & Motion (Elective)"
                      ] 
                    },
                    { 
                      ...
                      courses: [
                        ...
                        "Judicial Decision Making (Elective)"
                      ] 
                    },
                    { 
                      year: "Fourth Year (4L)", 
                       ...
                       trimesters: [
                         {
                           ...
                           courses: [
                             ...
                             { classNum: "L101", className: "Contracts I", units: "3 units", hours: "135 hours" },
                             { classNum: "L103", className: "Torts I", units: "3 units", hours: "135 hours" }
                           ]
                         },
                         {
                           name: "Winter (Jan.)",
                           courses: [
                             ...
                             { classNum: "L102", className: "Contracts II", units: "3 units", hours: "135 hours" }
                           ]
                         },
                         {
                           name: "Spring (May)",
                           courses: [
                             ...
                             { classNum: "L105", className: "Criminal Law", units: "4 units", hours: "180 hours" },
                             { classNum: "L102", className: "Contracts II", units: "3 units", hours: "135 hours" },
                             { classNum: "L104", className: "Torts II", units: "3 units", hours: "135 hours" },
                       ...
                       trimesters: [
                         {
                           name: "Fall (Sept.)",
                           courses: [
                             { classNum: "L201", className: "Civil Procedure", units: "6 units", hours: "270 hours" },
                             { classNum: "L205", className: "Uniform Commercial Code", units: "3 units", hours: "135 hours" },
                             { classNum: "L206", className: "Law & Motion", units: "1 unit", hours: "45 hours" }
                           ]
                         },
                         {
                           name: "Winter (Jan.)",
                           courses: [
                             { classNum: "L202", className: "Property", units: "6 units", hours: "270 hours" },
                             { classNum: "L205", className: "Uniform Commercial Code", units: "3 units", hours: "135 hours" },
                             { classNum: "L206", className: "Law & Motion", units: "1 unit", hours: "45 hours" }
                           ]
                         },
                         {
                           name: "Spring (May)",
                           courses: [
                             { classNum: "L203", className: "Remedies", units: "4 units", hours: "180 hours" },
                             { classNum: "L204", className: "Criminal Procedure", units: "4 units", hours: "180 hours" },
                             { classNum: "L205", className: "Uniform Commercial Code", units: "3 units", hours: "135 hours" },
                             { classNum: "L206", className: "Law & Motion", units: "1 unit", hours: "45 hours" }
                           ]
                         }
                       ...
                       trimesters: [
                         {
                           name: "Fall (Sept.)",
                           courses: [
                             { classNum: "L301", className: "Constitutional Law", units: "6 units", hours: "270 hours" },
                             { classNum: "L305", className: "Alternative Dispute Resolution", units: "3 units", hours: "135 hours" },
                             { classNum: "L306", className: "Judicial Decision Making", units: "3 units", hours: "135 hours" }
                           ]
                         },
                         {
                           name: "Winter (Jan.)",
                           courses: [
                             { classNum: "L302", className: "Evidence", units: "6 units", hours: "270 hours" },
                             { classNum: "L305", className: "Alternative Dispute Resolution", units: "3 units", hours: "135 hours" },
                             { classNum: "L306", className: "Judicial Decision Making", units: "3 units", hours: "135 hours" }
                           ]
                         },
                         {
                           name: "Spring (May)",
                           courses: [
                             { classNum: "L303", className: "Business Associations", units: "4 units", hours: "180 hours" },
                             { classNum: "L304", className: "Community Property", units: "4 units", hours: "180 hours" },
                             { classNum: "L305", className: "Alternative Dispute Resolution", units: "3 units", hours: "135 hours" },
                             { classNum: "L306", className: "Judicial Decision Making", units: "3 units", hours: "135 hours" }
                           ]
                         }
                       ...
                       trimesters: [
                         {
                           ...
                           courses: [
                             ...
                             { classNum: "L402", className: "California Civil Procedure", units: "2 units", hours: "90 hours" },
                             { classNum: "L407", className: "Bar Review", units: "4 units", hours: "180 hours" }
                           ]
                         },
                         {
                           name: "Winter (Jan.)",
                           courses: [
                             { classNum: "L403", className: "Wills & Succession", units: "4 units", hours: "180 hours" },
                             { classNum: "L404", className: "California Evidence", units: "2 units", hours: "90 hours" },
                             { classNum: "L407", className: "Bar Review", units: "4 units", hours: "180 hours" }
                           ]
                         },
                         {
