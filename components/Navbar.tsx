...
export const Navbar: React.FC<NavbarProps> = ({ 
  ...
  const navLinkClass = (isActive: boolean) => 
    `text-sm font-medium transition-all duration-300 cursor-pointer px-4 py-2 rounded-full tracking-wide ${
      isActive 
        ? 'text-pau-blue font-bold bg-pau-blue/5 ring-1 ring-pau-blue/10' 
  ...
  return (
    <nav 
      className={`fixed w-full top-0 z-50 transition-all duration-500 border-t-[5px] border-pau-gold ${
        scrolled 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          >
            ...
            <div className="w-10 h-10 bg-pau-blue text-white font-serif font-bold text-xl flex items-center justify-center rounded-sm shadow-md group-hover:bg-pau-darkBlue transition-colors">
              P
            </div>
            <div className="flex flex-col justify-center">
               <div className="flex flex-col">
                 <h1 className="text-pau-blue font-bold text-lg md:text-xl tracking-wider leading-none font-sans group-hover:text-pau-darkBlue transition-colors">
                   PACIFIC AMERICAN
                 </h1>
                 <h2 className="text-pau-gold font-medium text-xs md:text-sm tracking-[0.3em] leading-none font-sans mt-1 group-hover:text-pau-goldDark transition-colors">
                   UNIVERSITY
                 </h2>
               </div>
            </div>
          ...
          <div className="hidden md:flex items-center space-x-2">
            ...
            <div className="relative ml-4 pl-4 border-l border-gray-200">
              <button 
                ...
                className={`flex items-center space-x-2 text-gray-500 hover:text-pau-blue transition-colors rounded-full px-3 py-1.5 border border-transparent hover:border-gray-200 hover:bg-gray-50 ${isLangMenuOpen ? 'bg-gray-50 text-pau-blue' : ''}`}
              >
           ...
           <div className="flex items-center md:hidden">
            <button
              ...
              className="inline-flex items-center justify-center p-2 rounded-md text-gray-500 hover:text-pau-blue hover:bg-gray-50 focus:outline-none transition-colors"
            >
              {isMobileMenuOpen ? (
